...
Suporte oficial para a linguagem **Minerês** no Visual Studio Code. Escreva seus "causos" com o realce de sintaxe adequado e mergulhe na lógica computacional com o carisma mineiro.

Para a especificação completa da linguagem e dicionário de termos, acesse nosso site oficial:
👉 [**mineres-language.github.io**](https://mineres-language.github.io/)

---

## Como Instalar

A extensão pode ser instalada diretamente pela loja oficial do VS Code:

1. Abra o seu **Visual Studio Code**.
2. Vá até a aba de **Extensões** (`Ctrl+Shift+X`).
3. Pesquise por **"Minerês"**.
4. Clique em **Install** (Instalar).

Ou acesse diretamente pelo link: [Minerês no Marketplace](https://marketplace.visualstudio.com/items?itemName=grupo-mineres.mineres)
